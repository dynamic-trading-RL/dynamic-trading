...
fig,ax = plt.subplots()
contourf_ = ax.contourf(nn, ff, nn_RL, levels=100, vmin=vmin, vmax=vmax, cmap='RdBu')
cbar = fig.colorbar(contourf_)
plt.xlabel('$n_{t-1}$')
plt.ylabel('$f_t$')
plt.title('Shares RL')
plt.savefig('figures/RL_surface.png')

fig,ax = plt.subplots()
contourf_ = ax.contourf(nn, ff, nn_GP, levels=100, vmin=vmin, vmax=vmax, cmap='RdBu')
cbar = fig.colorbar(contourf_)
plt.xlabel('$n_{t-1}$')
plt.ylabel('$f_t$')
plt.title('Shares GP')
plt.savefig('figures/GP_surface.png')
